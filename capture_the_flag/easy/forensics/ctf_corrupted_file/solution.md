...
- After performing `exiftool file.jpg`, i get: 
    ...
    There is a problem here, we shouldnt get a file format error since a normal JPEG with a JFIF header should not throw an error. This is almost certain this file is corrupted. The next step we should perform is looking at the raw bytes 
